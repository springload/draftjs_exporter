...
class TestDOM(unittest.TestCase):
    ...
    def test_create_element_none(self):
        self.assertEqual(
            DOM.render_debug(
                DOM.create_element(
                    "a", {}, None, DOM.create_element("span", {}, "Test test")
                )
            ),
    ...
    def test_camel_to_dash(self):
        self.assertEqual(
            DOM.camel_to_dash("testCamelToDash"), "test-camel-to-dash"
        )
        self.assertEqual(
            DOM.camel_to_dash("TestCamelToDash"), "test-camel-to-dash"
        )
        ...
        self.assertEqual(
            DOM.camel_to_dash("TestCamelTODasH"), "test-camel-to-das-h"
        )
        self.assertEqual(
            DOM.camel_to_dash("testcameltodash"), "testcameltodash"
        )
        self.assertEqual(
